...
| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-196 | Doji | Candlestick | Indecision pattern | Low |
| IND-197 | Hammer / Hanging Man | Candlestick | Reversal single candle | Low |
| IND-198 | Engulfing | Candlestick | Bullish/bearish engulfing | Low |
| IND-199 | Harami | Candlestick | Inside bar pattern | Low |
| IND-200 | Morning Star / Evening Star | Candlestick | 3-candle reversal | Medium |
| IND-201 | Three White Soldiers / Black Crows | Candlestick | 3-candle continuation | Medium |
| IND-202 | Piercing / Dark Cloud Cover | Candlestick | 2-candle reversal | Low |
| IND-203 | Spinning Top | Candlestick | Small body, long wicks | Low |
| IND-204 | Marubozu | Candlestick | Full body, no wicks | Low |
| IND-205 | Tweezer Top / Bottom | Candlestick | Equal highs/lows | Low |
| IND-206 | Three Inside Up/Down | Candlestick | Harami confirmation | Medium |
| IND-207 | Three Outside Up/Down | Candlestick | Engulfing confirmation | Medium |
| IND-208 | Abandoned Baby | Candlestick | Gapped reversal | Medium |
| IND-209 | Shooting Star / Inverted Hammer | Candlestick | Long upper wick | Low |
| IND-210 | Belt Hold | Candlestick | Gap with strong body | Low |
| IND-211 | Kicking | Candlestick | Opposing Marubozu gap | Medium |
| IND-212 | Three Line Strike | Candlestick | 4-candle pattern | Medium |
| IND-213 | Tasuki Gap | Candlestick | Continuation gap | Medium |
| IND-214 | Rising / Falling Three Methods | Candlestick | 5-candle continuation | Medium |
...
| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-216 | Delta | Order Flow | Buy volume - sell volume | Medium |
| IND-217 | Cumulative Delta | Order Flow | Running delta total | Medium |
| IND-218 | Delta Divergence | Order Flow | Price vs delta divergence | Medium |
| IND-219 | Volume Delta Percentage | Order Flow | Delta as % of volume | Low |
| IND-220 | Imbalance Detector | Order Flow | Bid/ask volume imbalance | High |
| IND-221 | Absorption Detector | Order Flow | Large orders absorbed | High |
| IND-222 | POC (Point of Control) | Order Flow | Highest volume price | Medium |
| IND-223 | Value Area | Order Flow | 70% volume range | Medium |
| IND-224 | VWAP Bands | Order Flow | Standard deviation VWAP bands | Medium |
...
| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-228 | Wyckoff Wave | Wyckoff | Composite market indicator | High |
| IND-229 | Optimism-Pessimism Index | Wyckoff | Volume-based sentiment | Medium |
| IND-230 | Force Index (Wyckoff) | Wyckoff | Price × volume force | Medium |
| IND-231 | Technometer | Wyckoff | Overbought/oversold | Medium |
| IND-232 | Selling Climax Detector | Wyckoff | High volume reversal | High |
| IND-233 | Automatic Rally/Reaction | Wyckoff | Post-climax bounce | High |
| IND-234 | Spring / Upthrust | Wyckoff | False breakout detection | High |
| IND-235 | Sign of Strength / Weakness | Wyckoff | Trend quality | High |

## Priority 29: Seasonality & Time

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-236 | Day of Week Effect | Seasonality | Weekday performance | Low |
| IND-237 | Month of Year Effect | Seasonality | Monthly performance | Low |
| IND-238 | Turn of Month | Seasonality | Month boundary effect | Low |
| IND-239 | Holiday Effect | Seasonality | Pre/post holiday returns | Medium |
| IND-240 | Quarterly Effect | Seasonality | Quarter-end flows | Low |
| IND-241 | Options Expiration Effect | Seasonality | OpEx week behavior | Medium |
| IND-242 | Lunar Cycle | Seasonality | Moon phase correlation | Low |
| IND-243 | Intraday Seasonality | Seasonality | Hour-of-day patterns | Medium |
| IND-244 | Rolling Seasonality | Seasonality | Multi-year seasonal pattern | Medium |

## Priority 30: Options-Based

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-245 | Implied Volatility | Options | IV from option prices | High |
| IND-246 | IV Rank | Options | IV percentile over year | Medium |
| IND-247 | IV Percentile | Options | % of days IV was lower | Medium |
| IND-248 | Volatility Skew | Options | Put/call IV difference | Medium |
| IND-249 | Term Structure | Options | IV across expirations | Medium |
| IND-250 | Put/Call Open Interest | Options | OI ratio | Low |
...
| IND-257 | Size Factor | Factor | Market cap ranking | Low |
| IND-258 | Quality Factor | Factor | ROE, debt, earnings stability | Medium |
| IND-259 | Low Volatility Factor | Factor | Historical vol ranking | Medium |
| IND-260 | Dividend Yield Factor | Factor | Yield ranking | Low |
| IND-261 | Growth Factor | Factor | Earnings/revenue growth | Medium |
| IND-262 | Liquidity Factor | Factor | Trading volume/turnover | Medium |
| IND-263 | Reversal Factor | Factor | Short-term mean reversion | Medium |
| IND-264 | Composite Factor Score | Factor | Multi-factor combination | High |

## Priority 32: Crypto On-Chain Extended

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-265 | Active Addresses | On-Chain | Daily active addresses | Low |
| IND-266 | Transaction Count | On-Chain | Daily transactions | Low |
| IND-267 | Transfer Volume | On-Chain | USD volume transferred | Low |
| IND-268 | Exchange Inflow/Outflow | On-Chain | Exchange balance change | Medium |
| IND-269 | Whale Transactions | On-Chain | Large transfers count | Medium |
| IND-270 | HODL Waves | On-Chain | Coin age distribution | High |
| IND-271 | Realized Cap | On-Chain | Cost basis market cap | Medium |
| IND-272 | Thermocap Ratio | On-Chain | Market cap / miner revenue | Medium |
| IND-273 | Puell Multiple | On-Chain | Daily issuance value / 365 MA | Medium |
| IND-274 | Reserve Risk | On-Chain | HODL confidence vs price | High |
| IND-275 | Stock-to-Flow | On-Chain | Scarcity model | Medium |
| IND-276 | Stablecoin Supply Ratio | On-Chain | BTC cap / stablecoin cap | Medium |

## Priority 33: Sentiment & Alternative Data

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-277 | Social Volume | Sentiment | Social media mentions | Medium |
| IND-278 | Social Sentiment | Sentiment | Positive/negative ratio | High |
| IND-279 | News Sentiment | Sentiment | NLP news analysis | High |
| IND-280 | Google Trends | Sentiment | Search interest | Medium |
| IND-281 | Reddit/Twitter Activity | Sentiment | Platform-specific metrics | Medium |
| IND-282 | Commitment of Traders (COT) | Sentiment | Futures positioning | Medium |
| IND-283 | Smart Money Index | Sentiment | Late day vs early day | Medium |
| IND-284 | AAII Sentiment | Sentiment | Survey-based sentiment | Low |
| IND-285 | VIX Term Structure | Sentiment | Contango/backwardation | Medium |
| IND-286 | Insider Trading Ratio | Sentiment | Buy/sell ratio | Medium |

## Priority 34: Machine Learning Based

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-287 | SVM Trend Classifier | ML | Support vector classification | High |
...
| IND-293 | Autoencoder Anomaly | ML | Reconstruction error | High |
| IND-294 | HMM Regime | ML | Hidden Markov Model states | High |
| IND-295 | Reinforcement Learning Signal | ML | RL-based trading signal | High |

## Priority 35: Fixed Income & Rates

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-296 | Yield Curve Slope | Rates | 10Y - 2Y spread | Low |
| IND-297 | Yield Curve Curvature | Rates | Butterfly spread | Medium |
| IND-298 | Real Yield | Rates | Nominal - inflation | Low |
| IND-299 | Credit Spread | Rates | Corporate - Treasury | Low |
| IND-300 | TED Spread | Rates | LIBOR - T-Bill | Low |
| IND-301 | Swap Spread | Rates | Swap rate - Treasury | Low |
| IND-302 | Duration | Rates | Interest rate sensitivity | Medium |
| IND-303 | Convexity | Rates | Duration change rate | Medium |
| IND-304 | Carry | Rates | Roll-down return | Medium |
...
| IND-311 | Commitment of Traders (Forex) | Forex | Net positioning | Medium |
| IND-312 | Central Bank Policy Indicator | Forex | Hawkish/dovish score | High |
| IND-313 | Cross Rate Arbitrage | Forex | Triangular arbitrage | Medium |
...
| IND-317 | Unemployment Claims Trend | Economic | 4-week MA | Low |
| IND-318 | Housing Starts Trend | Economic | YoY change | Low |
| IND-319 | Consumer Confidence Delta | Economic | MoM change | Low |
| IND-320 | ISM New Orders | Economic | Leading component | Low |
| IND-321 | Real M2 Growth | Economic | Money supply change | Medium |
| IND-322 | Financial Conditions Index | Economic | Composite stress index | High |

## Priority 38: Additional Gann & Cycle

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-323 | Gann Fan | Gann | Trend lines at angles | Medium |
| IND-324 | Gann Square of 9 | Gann | Price/time squaring | High |
| IND-325 | Gann Hexagon | Gann | Hexagonal chart | High |
| IND-326 | Planetary Cycles | Gann | Astronomical correlations | High |
| IND-327 | Fibonacci Time Zones | Cycle | Fib time projections | Medium |
| IND-328 | Cycle Finder | Cycle | Dominant cycle detection | High |
...
| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-333 | Head and Shoulders | Pattern | Classic reversal | High |
| IND-334 | Double Top / Bottom | Pattern | M/W patterns | Medium |
| IND-335 | Triple Top / Bottom | Pattern | Extended reversal | Medium |
| IND-336 | Cup and Handle | Pattern | Continuation pattern | High |
| IND-337 | Wedge (Rising/Falling) | Pattern | Converging trend lines | Medium |
| IND-338 | Flag / Pennant | Pattern | Continuation patterns | Medium |
| IND-339 | Rectangle | Pattern | Range consolidation | Medium |
| IND-340 | Triangle (Sym/Asc/Desc) | Pattern | Converging patterns | Medium |
| IND-341 | Channel (Parallel) | Pattern | Trend channel | Medium |
| IND-342 | Rounding Bottom / Top | Pattern | Saucer pattern | High |
| IND-343 | Island Reversal | Pattern | Gapped isolation | Medium |
| IND-344 | Diamond | Pattern | Rare reversal | High |
| IND-345 | Broadening Formation | Pattern | Megaphone | Medium |
...
| IND-347 | Butterfly Pattern | Harmonic | Extended Gartley | High |
| IND-348 | Bat Pattern | Harmonic | 0.886 retracement | High |
| IND-349 | Crab Pattern | Harmonic | 1.618 extension | High |
| IND-350 | Shark Pattern | Harmonic | 0.886/1.13 pattern | High |
| IND-351 | Cypher Pattern | Harmonic | Darren Oglesbee pattern | High |
| IND-352 | ABCD Pattern | Harmonic | Simple harmonic | Medium |
...
| IND-377 | London Session Range | Session | London session H/L | Low |
| IND-378 | NY Session Range | Session | New York session H/L | Low |
...
| IND-389 | Fibonacci Fans | Fibonacci | Angled trend lines | Medium |
| IND-390 | Fibonacci Channels | Fibonacci | Parallel channel levels | Medium |
| IND-391 | Fibonacci Clusters | Fibonacci | Multi-swing confluence | High |
| IND-392 | Auto Fibonacci | Fibonacci | Automatic swing detection | High |
| IND-393 | Fibonacci Speed Resistance | Fibonacci | Time-price grid | Medium |

## Priority 45: Market Internals

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-394 | NYSE Tick | Internals | Uptick - downtick stocks | Low |
| IND-395 | NYSE TRIN (Arms) | Internals | A/D ratio / volume ratio | Medium |
| IND-396 | VIX Fix | Internals | Synthetic VIX from price | Medium |
| IND-397 | Cumulative Tick | Internals | Running tick total | Low |
| IND-398 | TICK Extreme | Internals | Extreme readings | Low |
| IND-399 | ADD (Advance/Decline) | Internals | Real-time A/D | Low |
| IND-400 | UVOL/DVOL Ratio | Internals | Up/down volume ratio | Low |
| IND-401 | Sector Rotation Model | Internals | Business cycle position | High |
| IND-402 | Risk-On/Risk-Off | Internals | Cross-asset risk measure | High |
| IND-403 | Intermarket Divergence | Internals | Asset class divergence | Medium |

## Priority 46: Tail Risk & Extreme Events

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-404 | Skewness | Tail Risk | Distribution asymmetry | Medium |
| IND-405 | Kurtosis | Tail Risk | Distribution tails | Medium |
| IND-406 | Expected Shortfall | Tail Risk | CVaR / tail mean | Medium |
| IND-407 | Tail Dependence | Tail Risk | Copula tail measure | High |
| IND-408 | Jump Detection | Tail Risk | Price jump identifier | High |
| IND-409 | Extreme Value Index | Tail Risk | GEV/GPD estimation | High |
| IND-410 | Black Swan Index | Tail Risk | Tail event probability | High |
| IND-411 | Crisis Alpha | Tail Risk | Performance in crashes | High |
| IND-412 | Stress Index | Tail Risk | Market stress composite | High |

## Priority 47: Commodities Specific

| ID | Indicator | Category | Description | Complexity |
|----|-----------|----------|-------------|------------|
| IND-413 | Contango/Backwardation | Commodity | Futures curve shape | Medium |
| IND-414 | Roll Yield | Commodity | Calendar spread return | Medium |
| IND-415 | Convenience Yield | Commodity | Spot premium | Medium |
| IND-416 | Inventory Levels | Commodity | Storage data | Low |
| IND-417 | Crack Spread | Commodity | Refining margin | Low |
| IND-418 | Crush Spread | Commodity | Soybean processing margin | Low |
...
| IND-497 | Carry Trade Signal | Cross-Asset | FX carry opportunities | Medium |
| IND-498 | Global Macro Regime | Cross-Asset | Growth/inflation matrix | High |
| IND-499 | Flight to Quality | Cross-Asset | Safe haven flows | Medium |
| IND-500 | Real Asset Allocation | Cross-Asset | Inflation hedge signal | Medium |
