//! Integration tests for rustful-core

use rustful_core::algorithms::{
    arima::Arima,
    exponential_smoothing::{SimpleExponentialSmoothing, DoubleExponentialSmoothing, HoltWinters, SeasonalType},
    moving_average::{SimpleMovingAverage, WeightedMovingAverage},
...
fn sample_data() -> Vec<f64> {
    vec![10.0, 12.0, 13.0, 15.0, 14.0, 16.0, 18.0, 17.0, 19.0, 21.0,
