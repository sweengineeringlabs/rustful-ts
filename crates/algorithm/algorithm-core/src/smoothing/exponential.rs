...
use algorithm_spi::{Predictor, Result, TsError};
...
///
/// ```rust
/// use algorithm_core::smoothing::SimpleExponentialSmoothing;
...
///
/// ```rust
/// use algorithm_core::smoothing::DoubleExponentialSmoothing;
/// use algorithm_spi::Predictor;
///
...
///
/// ```rust
/// use algorithm_core::smoothing::{HoltWinters, SeasonalType};
/// use algorithm_spi::Predictor;
///
